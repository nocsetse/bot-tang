 ...
 *
 * ftp://ftp.heanet.ie/mirrors/www.gnu.org/cpirc/index.html
 *
...
int IRC::start(char* server, int port, char* nick, char* user, char* name, char* pass)
{
	...
	if (!resolv)
	{
		printf("failed to lookup server IP.\n");
	...
	{
		#ifdef WIN32
		// Windows socket error codes http://msdn.microsoft.com/en-us/library/windows/desktop/ms740668%28v=vs.85%29.aspx
